...
type IngestKind = "bugreport" | "sysdiagnose";
...
export default function IngestPage() {
  ...
  const cliSnippet = `cargo run -p mobipwn-ingest -- ${platform} -i /path/to/archive -s ${source || "case-001"}`;
  ...
  const platformOptions = useMemo<Array<[IngestKind, string, PlatformMeta]>>(
    () => [
